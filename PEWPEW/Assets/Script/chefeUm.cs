...
public class chefeUm : MonoBehaviour
{
    ...
    void Start(){   
        shield= GameObject.FindGameObjectWithTag("ATField");
        tiro  = GameObject.FindGameObjectWithTag("pistola");
        cenaAtual = SceneManager.GetActiveScene(); // recebe o nome da cena atual
    ...
    IEnumerator morteChefe(){
        ...
        shield.GetComponent<ATField>().enabled = false;
        tiro.GetComponent<atirar>().enabled = false;
